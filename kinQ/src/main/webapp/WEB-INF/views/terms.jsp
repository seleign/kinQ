...
<html>
  ...
  <script type="text/javascript">
  	...
  	function changeToTerms(){
  		...
  		html+='<strong id="term6">第6条 [不正利用禁止および違約罰]</strong><hr>';
  		...
  		html+='<strong id="term7">第7条 【講座制裁]</strong><hr>';
  		...
  		html+='<strong id="term8">第8条 [収益の配分や精算]</strong><hr>';
  		...
  		html+='<strong id="term9">第9条 [アップロードコンテンツの責任及び権利]</strong><br>';
  		...
  		html+='<strong id="term10">第10条 〔価格設定および割引]</strong>';
  		...
  		html+='<strong id="term11">第11条 [コンテンツ利用期間設定]</strong>';
  		...
  		html+='<strong id="term12">第12条 [会社の義務]</strong>';
  		...
  		html+='<strong id="term13">第13条 [紛争の解決]</strong>';
