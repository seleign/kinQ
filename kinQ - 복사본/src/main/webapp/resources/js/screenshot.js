...
(function(t, e, i, r, n, o) {
    ...
    function p(t, i) {
        for (var r = 3 === t.nodeType ? e.createTextNode(t.nodeValue) : t.cloneNode(!1), n = t.firstChild; n;) !0 !== i && 1 === n.nodeType && "SCRIPT" === n.nodeName || r.appendChild(p(n, i)), n = n.nextSibling;
        return r
    }
            ...
            if (!(0 === c && " \r\n\t".indexOf(t) > -1)) {
                switch (t) {
                    ...
                    case ",":
                        ...
                        if (1 === c && 0 === l && !e.match(/^url$/i)) return a.push(i), i = "", void(o += t)
                }
                o += t, 0 === c ? e += t : i += t
            }
        }), u(), h
    ...
    function Tt(e) {
        for (var i, r = [], n = 0, o = !1; e.length;) Ot(e[n]) === o ? ((i = e.splice(0, n)).length && r.push(t.html2canvas.punycode.ucs2.encode(i)), o = !o, n = 0) : n++, n >= e.length && (i = e.splice(0, n)).length && r.push(t.html2canvas.punycode.ucs2.encode(i));
        return r
    }
    ...
    function Nt(t) {
        var e, i, r, n, o, s, a, h = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",
            c = t.length,
            l = "";
        for (e = 0; e < c; e += 4) o = h.indexOf(t[e]) << 2 | (i = h.indexOf(t[e + 1])) >> 4, s = (15 & i) << 4 | (r = h.indexOf(t[e + 2])) >> 2, a = (3 & r) << 6 | (n = h.indexOf(t[e + 3])), l += 64 === r ? String.fromCharCode(o) : 64 === n || -1 === n ? String.fromCharCode(o, s) : String.fromCharCode(o, s, a);
        return l
    }
    ...
    if (function() {
            ...
            function s() {
                for (var t = 0; t < _; t += 2)(0, k[t])(k[t + 1]), k[t] = void 0, k[t + 1] = void 0;
                _ = 0
            }
            ...
            function m(t) {
                var e = t.e,
                    i = t.a;
                if (0 !== e.length) {
                    for (var r, n, o = t.b, s = 0; s < e.length; s += 3) r = e[s], n = e[s + i], r ? b(i, r, n, o) : n(o);
                    t.e.length = 0
                }
            }
            ...
            x.prototype.o = function(t) {
                ...
                for (var t = this.length, e = this.c, i = this.m, r = 0; void 0 === e.a && r < t; r++) this.j(i[r], r)
            ...
            w.all = function(t, e) {
                ...
                var i = new this(a, e);
                if (!C(t)) return p(i, new TypeError("You must pass an array to race.")), i;
                for (var r = t.length, n = 0; void 0 === i.a && n < r; n++) g(this.resolve(t[n]), void 0, function(t) {
                    u(i, t)
                }, function(t) {
                    p(i, t)
                });
        ...
        ! function(t) {
            ...
            function f(t) {
                var i, r, n, o, s, a, l, f, d, p, g = [],
                    ...
                    b = O,
                    C = T;
                for ((r = t.lastIndexOf(k)) < 0 && (r = 0), n = 0; n < r; ++n) t.charCodeAt(n) >= 128 && e("not-basic"), g.push(t.charCodeAt(n));
                for (o = r > 0 ? r + 1 : 0; o < m;) {
                    for (s = v, a = 1, l = x; o >= m && e("invalid-input"), ((f = c(t.charCodeAt(o++))) >= x || f > M((y - v) / a)) && e("overflow"), v += f * a, d = l <= C ? w : l >= C + S ? S : l - C, !(f < d); l += x) a > M(y / (p = x - d)) && e("overflow"), a *= p;
                ...
                for (n = o = _.length, o && _.push(k); n < m;) {
                    ...
                    for (c - i > M((y - r) / (v = n + 1)) && e("overflow"), r += (c - i) * v, i = c, h = 0; h < m; ++h)
                        if ((g = t[h]) < i && ++r > y && e("overflow"), g == i) {
                            for (f = r, d = x; p = d <= s ? w : d >= s + S ? S : d - s, !(f < p); d += x) C = f - p, b = x - p, _.push(D(l(p + C % b, 0))), f = M(C / b);
            ...
            if (v = {
                ...
                }, "function" == typeof n && "object" == typeof n.amd && n.amd) n("punycode", function() {
                return v
            });
            else if (p && g)
                if (module.exports == p) g.exports = v;
                else
                    for (b in v) v.hasOwnProperty(b) && (p[b] = v[b]);
            else t.punycode = v
        }(this);
        ...
        E.prototype.getMetrics = function(t, e) {
            ...
            this.nodes.forEach(function(t) {
                if (pt(t)) {
                    ...
                    ]), t.clip = Y(t) ? t.parent.clip.concat(e) : e, t.backgroundClip = "hidden" !== t.css("overflow") ? t.clip.concat([t.borders.clip]) : t.clip, gt(t) && t.cleanDOM()
            ...
            if (s.className = Dt.prototype.PSEUDO_HIDE_ELEMENT_CLASS_BEFORE + " " + Dt.prototype.PSEUDO_HIDE_ELEMENT_CLASS_AFTER, o) return s.src = N(n)[0].args[0], [a];
        ...
        var Cufon = function() {
            ...
            function e() {
                ...
                this.add = function(e) {
                    ...
                    for (var c in n) c = parseInt(c, 10), (!o || c < o) && (o = c), (!s || c > s) && (s = c), h.push(c);
            ...
            function s(t, e) {
                ...
                for (var i, r = d.quotedList(e.get("fontFamily").toLowerCase()), n = 0, o = r.length; n < o; ++n)
                    if (i = r[n], y[i]) return y[i].get(e.get("fontStyle"), e.get("fontWeight"));
                return null
            }
            ...
            function c(t, e, i, r, n, o) {
                ...
                for (var u = 0, f = c.length; u < f; ++u)(a = b[r.engine](t, l ? d.textAlign(c[u], i, u, f) : c[u], i, r, n, o, u < f - 1)) && h.appendChild(a);
                return h
            }
                ...
                d = u.CSS = {
                    ...
                    ready: function() {
                        ...
                        return f.ready(function() {
                                for (var t, e = 0, o = 0, s = n.length; t = n[o], o < s; ++o) t.disabled || "stylesheet" != t.rel.toLowerCase() || ++e;
                    ...
                    textShadow: o(function(t) {
                        ...
                        for (var e, i = [], r = {}, n = 0, o = /(#[a-f0-9]+|[a-z]+\(.*?\)|[a-z]+)|(-?[\d.]+[a-z%]*)|,/gi; e = o.exec(t);) "," == e[0] ? (i.push(r), r = {}, n = 0) : e[1] ? r.color = e[1] : r[["offX", "offY", "blur"][n++]] = e[2];
                        return i.push(r), i
                    }),
                    color: o(function(t) {
                        var e = {};
        ...
        Cufon.registerEngine("canvas", function() {
                ...
                return fabric.document.getElementsByTagName("head")[0].appendChild(n),
                    function(r, n, o, s, a, h) {
                        ...
                        for (var H = Cufon.textOptions.shadowOffsets, y = b.length; y--;) H[y] = [b[y][0] * Y, b[y][1] * Y];
            ...
            }, void 0 !== exports && (exports.Cufon = Cufon), "object" != typeof JSON && (JSON = {}),
            function() {
                "use strict";
                    ...
                    switch (h && "object" == typeof h && "function" == typeof h.toJSON && (h = h.toJSON(t)), "function" == typeof rep && (h = rep.call(e, t, h)), typeof h) {
                        ...
                        case "object":
                            ...
                            if (rep && "object" == typeof rep)
                                for (o = rep.length, i = 0; i < o; i += 1) "string" == typeof rep[i] && (n = str(r = rep[i], h)) && s.push(quote(r) + (gap ? ": " : ":") + n);
                            else
                                for (r in h) Object.prototype.hasOwnProperty.call(h, r) && (n = str(r, h)) && s.push(quote(r) + (gap ? ": " : ":") + n);
                            return n = 0 === s.length ? "{}" : gap ? "{\n" + gap + s.join(",\n" + gap) + "\n" + a + "}" : "{" + s.join(",") + "}", gap = a, n
                    }
                }
                ...
                "function" != typeof JSON.stringify && (escapable = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, meta = {
                    ...
                    function walk(t, e) {
                        ...
                        if (n && "object" == typeof n)
                            for (i in n) Object.prototype.hasOwnProperty.call(n, i) && ((r = walk(n, i)) !== undefined ? n[i] = r : delete n[i]);
            ...
            function() {
                ...
                function r(t, e) {
                    if (this.__eventListeners) {
                        ...
                        if (i) {
                            for (var r = 0, n = i.length; r < n; r++) i[r].call(this, e || {});
                            return this
                        }
                    }
                }
            ...
            function() {
                function t(t, n, s, a, h, c, l) {
                    ...
                    for (var M = Math.ceil(Math.abs(P / (.5 * f))), D = [], L = P / M, R = 8 / 3 * Math.sin(L / 4) * Math.sin(L / 4) / Math.sin(L / 2), B = I + L, F = 0; F < M; F++) D[F] = e(I, B, g, p, s, a, A, j, R, m, v), m = D[F][4], v = D[F][5], I += L, B += L;
                    return r[u] = D, D
                }
                ...
                fabric.util.drawArc = function(e, i, r, n) {
                    for (var o = n[0], s = n[1], a = n[2], h = n[3], c = n[4], l = [
                            [],
                            [],
                            [],
                            []
                        ], u = t(n[5] - i, n[6] - r, o, s, h, c, a), f = 0, d = u.length; f < d; f++) l[f][0] = u[f][0] + i, l[f][1] = u[f][1] + r, l[f][2] = u[f][2] + i, l[f][3] = u[f][3] + r, l[f][4] = u[f][4] + i, l[f][5] = u[f][5] + r, e.bezierCurveTo.apply(e, l[f])
                }
            }(),
            function() {
                function t(t, e, i) {
            ...
            function() {
                ...
                function r(t, e) {
                    return function(i) {
                        if (p[t] && p[t][e])
                            for (var r = p[t][e], n = 0, o = r.length; n < o; n++) r[n].call(this, i || fabric.window.event)
                    }
                }
                ...
                u ? (c = function(t, e, i) {
                    ...
                    var r, n = h(t);
                    if (d[n] && d[n][e])
                        for (var o = 0, s = d[n][e].length; o < s; o++)(r = d[n][e][o]) && r.handler === i && (t.detachEvent("on" + e, r.wrappedHandler), d[n][e][o] = null)
                }) : (c = function(t, e, i) {
                    var n = h(t);
                    if (p[n] || (p[n] = {}), !p[n][e]) {
                        p[n][e] = [];
                    ...
                    var r = h(t);
                    if (p[r] && p[r][e])
                        for (var n = p[r][e], o = 0, s = n.length; o < s; o++) n[o] === i && n.splice(o, 1)
            ...
            function() {
                ...
                n = fabric.document.defaultView && fabric.document.defaultView.getComputedStyle ? function(t, e) {
                    ...
                    function() {
                        ...
                        for (r = t; t && t.parentNode && !i;)(t = t.parentNode) !== fabric.document && "fixed" === fabric.util.getElementStyle(t, "position") && (i = t), t !== fabric.document && r !== e && "absolute" === fabric.util.getElementStyle(t, "position") ? (n = 0, o = 0) : t === fabric.document ? (n = a.scrollLeft || s.scrollLeft || 0, o = a.scrollTop || s.scrollTop || 0) : (n += t.scrollLeft || 0, o += t.scrollTop || 0);
                        return {
                            left: n,
                            top: o
                        }
            ...
            function(t) {
                ...
                function l(t, e) {
                    ...
                    if (i = new RegExp("^" + r, "i"), e = e.replace(i, ""), o && e.length && (i = new RegExp("#" + o + "(?![a-zA-Z\\-]+)", "i"), e = e.replace(i, "")), n && e.length)
                        for (var s = (n = n.split(" ")).length; s--;) i = new RegExp("\\." + n[s] + "(?![a-zA-Z\\-]+)", "i"), e = e.replace(i, "");
                    return 0 === e.length
                }
                ...
                g.parseTransformAttribute = function() {
                    ...
                    return function(s) {
                        ...
                        for (var f = u[0]; u.length > 1;) u.shift(), f = g.util.multiplyTransformMatrices(f, u[0]);
                        return f
                    }
                ...
                m(g, {
                    getGradientDefs: function(t) {
                        ...
                        for (; a--;) n = (e = h[a]).getAttribute("xlink:href"), r = e.getAttribute("id"), n && (l[r] = n.substr(1)), c[r] = e;
                        for (r in l) {
                ...
                for (var t = 0, e = this.elements.length; t < e; t++) ! function(t, e) {
                    setTimeout(function() {
            ...
            function() {
                ...
                function r(t, e, i) {
                    var r, n = 0,
                        o = 1,
                        s = "";
                    for (var a in e) r = parseFloat(e[a], 10), o = "string" == typeof e[a] && /^\d+%$/.test(e[a]) ? .01 : 1, "x1" === a || "x2" === a || "r2" === a ? (o *= "objectBoundingBox" === i ? t.width : 1, n = "objectBoundingBox" === i ? t.left || 0 : 0) : "y1" !== a && "y2" !== a || (o *= "objectBoundingBox" === i ? t.height : 1, n = "objectBoundingBox" === i ? t.top || 0 : 0), e[a] = r * o + n;
                ...
                initialize: function(t) {
                    if (t || (t = {}), this.id = fabric.Object.__uid++, t.source)
                        if ("string" == typeof t.source)
                            if (void 0 !== fabric.util.getFunctionBody(t.source)) this.source = new Function(fabric.util.getFunctionBody(t.source));
                            else {
                                var e = this;
                ...
                if (fabric.StaticCanvas) fabric.warn("fabric.StaticCanvas is already defined.");
                    ...
                    fabric.StaticCanvas = fabric.util.createClass({
                        ...
                        _renderObjects: function(t, e) {
                            var i, r;
                            if (e)
                                for (i = 0, r = this._objects.length; i < r; ++i) this._objects[i] && !e.contains(this._objects[i]) && this._draw(t, this._objects[i]);
                            else
                                for (i = 0, r = this._objects.length; i < r; ++i) this._draw(t, this._objects[i])
                        },
                        ...
                        _setSVGObjects: function(t, e) {
                            ...
                            for (var r = 0, n = this.getObjects(), o = n.length; r < o; r++) t.push(n[r].toSVG(e));
            ...
            function() {
                ...
                fabric.util.object.extend(fabric.Object.prototype, {
                    ...
                    _findCrossPoints: function(t, e) {
                        var i, r, n, o, s, a = 0;
                        for (var h in e)
                            if (!((s = e[h]).o.y < t.y && s.d.y < t.y || s.o.y >= t.y && s.d.y >= t.y || (s.o.x === s.d.x && s.o.x >= t.x ? (o = s.o.x, t.y) : (i = 0, r = (s.d.y - s.o.y) / (s.d.x - s.o.x), (n = t.y - i * t.x) + i * (o = -(n - (s.o.y - r * s.o.x)) / (i - r))), o >= t.x && (a += 1), 2 !== a))) break;
                        return a
                    },
            ...
            function(t) {
                ...
                e.Polygon ? e.warn("fabric.Polygon is already defined") : (e.Polygon = e.util.createClass(e.Object, {
                    ...
                    _renderDashedStroke: function(t) {
                        var i, r;
                        t.beginPath();
                        for (var n = 0, o = this.points.length; n < o; n++) i = this.points[n], r = this.points[n + 1] || this.points[0], e.util.drawDashedLine(t, i.x, i.y, r.x, r.y, this.strokeDashArray);
                        t.closePath()
                    },
                    complexity: function() {
                    ...
                    _parsePath: function() {
                        for (var t, e, i, r, n, o = [], s = [], a = /([-+]?((\d+\.\d+)|((\d+)|(\.\d+)))(?:e[-+]?\d+)?)/gi, h = 0, u = this.path.length; h < u; h++) {
                            ...
                            var p = n[0],
                                ...
                                m = l[p] || p;
                            if (n.length - 1 > g)
                                for (var v = 1, b = n.length; v < b; v += g) o.push([p].concat(n.slice(v, v + g))), p = m;
                            else o.push(n)
                        }
                        return o
                    },
                ...
                e.PathGroup ? e.warn("fabric.PathGroup is already defined") : (e.PathGroup = e.util.createClass(e.Path, {
                    ...
                    render: function(t) {
                        if (this.visible) {
                            ...
                            for (var r = 0, n = this.paths.length; r < n; ++r) this.paths[r].render(t, !0);
                    ...
                    e.Group = e.util.createClass(e.Object, e.Collection, {
                        ...
                        _calcBounds: function(t) {
                            for (var e, i = [], r = [], n = 0, o = this._objects.length; n < o; ++n) {
                                ...
                                for (var s in e.oCoords) i.push(e.oCoords[s].x), r.push(e.oCoords[s].y)
                            }
                ...
                t.fabric || (t.fabric = {}), t.fabric.Image ? fabric.warn("fabric.Image is already defined.") : (fabric.Image = fabric.util.createClass(fabric.Object, {
                    ...
                    applyFilters: function(t) {
                        if (this._originalElement) {
                            if (0 === this.filters.length) return this._element = this._originalElement, void(t && t());
            ...
            function(t) {
                ...
                e.Image.filters.Brightness = e.util.createClass(e.Image.filters.BaseFilter, {
                    ...
                    applyTo: function(t) {
                        for (var e = t.getContext("2d"), i = e.getImageData(0, 0, t.width, t.height), r = i.data, n = this.brightness, o = 0, s = r.length; o < s; o += 4) r[o] += n, r[o + 1] += n, r[o + 2] += n;
            ...
            function(t) {
                ...
                e.Image.filters.Grayscale = e.util.createClass(e.Image.filters.BaseFilter, {
                    type: "Grayscale",
                    applyTo: function(t) {
                        for (var e, i = t.getContext("2d"), r = i.getImageData(0, 0, t.width, t.height), n = r.data, o = r.width * r.height * 4, s = 0; s < o;) e = (n[s] + n[s + 1] + n[s + 2]) / 3, n[s] = e, n[s + 1] = e, n[s + 2] = e, s += 4;
                ...
                e.Image.filters.Invert = e.util.createClass(e.Image.filters.BaseFilter, {
                    ...
                    applyTo: function(t) {
                        var e, i = t.getContext("2d"),
                            ...
                            n = r.data,
                            o = n.length;
                        for (e = 0; e < o; e += 4) n[e] = 255 - n[e], n[e + 1] = 255 - n[e + 1], n[e + 2] = 255 - n[e + 2];
                        i.putImageData(r, 0, 0)
                    }
            ...
            function(t) {
                ...
                e.Image.filters.Noise = e.util.createClass(e.Image.filters.BaseFilter, {
                    ...
                    applyTo: function(t) {
                        for (var e, i = t.getContext("2d"), r = i.getImageData(0, 0, t.width, t.height), n = r.data, o = this.noise, s = 0, a = n.length; s < a; s += 4) e = (.5 - Math.random()) * o, n[s] += e, n[s + 1] += e, n[s + 2] += e;
                        i.putImageData(r, 0, 0)
                    },
                    toObject: function() {
                        return i(this.callSuper("toObject"), {
                        ...
                        for (i = 0; i < u; i += this.blocksize)
                            for (r = 0; r < f; r += this.blocksize) {
                                ...
                                for (var d = i, p = i + this.blocksize; d < p; d++)
                                    for (var g = r, m = r + this.blocksize; g < m; g++) l[e = 4 * d * f + 4 * g] = n, l[e + 1] = o, l[e + 2] = s, l[e + 3] = a
                            }
            ...
            function(t) {
                ...
                e.Image.filters.RemoveWhite = e.util.createClass(e.Image.filters.BaseFilter, {
                    ...
                    applyTo: function(t) {
                        for (var e, i, r, n = t.getContext("2d"), o = n.getImageData(0, 0, t.width, t.height), s = o.data, a = this.threshold, h = this.distance, c = 255 - a, l = Math.abs, u = 0, f = s.length; u < f; u += 4) e = s[u], i = s[u + 1], r = s[u + 2], e > c && i > c && r > c && l(e - i) < h && l(e - r) < h && l(i - r) < h && (s[u + 3] = 1);
                ...
                e.Image.filters.Sepia = e.util.createClass(e.Image.filters.BaseFilter, {
                    ...
                    applyTo: function(t) {
                        var e, i, r = t.getContext("2d"),
                            ...
                            o = n.data,
                            s = o.length;
                        for (e = 0; e < s; e += 4) i = .3 * o[e] + .59 * o[e + 1] + .11 * o[e + 2], o[e] = i + 100, o[e + 1] = i + 50, o[e + 2] = i + 255;
                        r.putImageData(n, 0, 0)
                    }
                ...
                e.Image.filters.Tint = e.util.createClass(e.Image.filters.BaseFilter, {
                    ...
                    applyTo: function(t) {
                        var i, r, n, o, s, a, h, c, l, u = t.getContext("2d"),
                            ...
                            d = f.data,
                            p = d.length;
                        for (r = (l = new e.Color(this.color).getSource())[0] * this.opacity, n = l[1] * this.opacity, o = l[2] * this.opacity, c = 1 - this.opacity, i = 0; i < p; i += 4) s = d[i], a = d[i + 1], h = d[i + 2], d[i] = r + s * c, d[i + 1] = n + a * c, d[i + 2] = o + h * c;
                ...
                e.Image.filters.Multiply = e.util.createClass(e.Image.filters.BaseFilter, {
                    ...
                    applyTo: function(t) {
                        var i, r, n = t.getContext("2d"),
                            ...
                            s = o.data,
                            a = s.length;
                        for (r = new e.Color(this.color).getSource(), i = 0; i < a; i += 4) s[i] *= r[0] / 255, s[i + 1] *= r[1] / 255, s[i + 2] *= r[2] / 255;
                        n.putImageData(o, 0, 0)
                    },
                    toObject: function() {
                        return i(this.callSuper("toObject"), {
            ...
            function(t) {
                ...
                e.Image.filters.Blend = e.util.createClass({
                    ...
                    applyTo: function(t) {
                        ...
                        } else i = (h = new e.Color(this.color).getSource())[0] * this.alpha, r = h[1] * this.alpha, n = h[2] * this.alpha;
                        for (var g = 0, m = u.length; g < m; g += 4) switch (o = u[g], s = u[g + 1], a = u[g + 2], f && (i = h[g] * this.alpha, r = h[g + 1] * this.alpha, n = h[g + 2] * this.alpha), this.mode) {
                            case "multiply":
                    ...
                    s.push("fontFamily", "fontWeight", "fontSize", "text", "textDecoration", "textAlign", "fontStyle", "lineHeight", "textBackgroundColor", "useNative", "path"), e.Text = e.util.createClass(e.Object, {
                        ...
                        _renderTextLine: function(t, e, i, r, n, o) {
                            if (n -= this.fontSize / 4, "justify" === this.textAlign) {
                                var s = e.measureText(i).width,
                                    a = this.width;
                                if (a > s)
                                    for (var h = i.split(/\s+/), c = (a - e.measureText(i.replace(/\s+/g, "")).width) / (h.length - 1), l = 0, u = 0, f = h.length; u < f; u++) this._renderChars(t, e, h[u], r + l, n, o), l += e.measureText(h[u]).width + c;
                        ...
                        _renderTextFill: function(t, e) {
                            if (this.fill || this._skipFillStrokeCheck) {
                                this._boundaries = [];
                                for (var i = 0, r = 0, n = e.length; r < n; r++) i += this._getHeightOfLine(t, r, e), this._renderTextLine("fillText", t, e[r], this._getLeftOffset(), this._getTopOffset() + i, r)
                            }
                        },
                        _renderTextStroke: function(t, e) {
                            if (this.stroke && 0 !== this.strokeWidth || this._skipFillStrokeCheck) {
                                ...
                                for (var r = 0, n = e.length; r < n; r++) i += this._getHeightOfLine(t, r, e), this._renderTextLine("strokeText", t, e[r], this._getLeftOffset(), this._getTopOffset() + i, r);
                        ...
                        _getSVGTextAndBg: function(t, e, i) {
                            var r = [],
                                ...
                                o = 1;
                            this._setSVGBg(n);
                            for (var s = 0, a = i.length; s < a; s++) "" !== i[s] ? (this._setSVGTextLineText(i[s], s, r, t, o, n), o = 1) : o++, this.textBackgroundColor && this._boundaries && this._setSVGTextLineBg(n, s, e, t);
                            return {
                                textSpans: r,
                                textBgRects: n
                            }
